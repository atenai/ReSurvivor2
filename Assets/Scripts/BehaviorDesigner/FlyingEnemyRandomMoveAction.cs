...
public class FlyingEnemyRandomMoveAction : Action
{
    ...
    void TargetPos()
    {
        ...
        endPos = new Vector3(this.transform.position.x + xPos, this.transform.position.y + yPos, this.transform.position.z + zPos);
