...
public class FlyingEnemyStraightLineTrackingAction1 : Action
{
	...
	void TargetPos()
	{
		float xPos = flyingEnemy.TargetPlayer.transform.position.x;
		float yPos = flyingEnemy.TargetPlayer.transform.position.y;
		float zPos = flyingEnemy.TargetPlayer.transform.position.z;
