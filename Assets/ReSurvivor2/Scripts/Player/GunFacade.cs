...
public class GunFacade
{
	...
	public void Load()
	{
		...
		PlayerManagerPresenter.SingletonInstance.PlayerCharacterView.GunModelFacade.SwitchWeaponModel(this.gunTYPE);
	}

	/// <summary>
	/// 銃の更新処理
	/// </summary>
	public void UpdateGun(bool isAim)
	{
		SwitchWeaponTrigger();
		gunBase.AllSystem(isAim);
	}
