...
public class ParticleSystemPlayRockImpactEffectPool : MonoBehaviour
{
	...
	private void ReturnToPool()
	{
		...
		isReturned = true;
		EffectManager.SingletonInstance.RockImpactEffectPool.ReleaseGameObject(this.gameObject);
	}
}
